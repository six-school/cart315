...
<figure class="image">
  <img src="fixing-workflow.png" alt="many failed github actions runs.">
  <figcaption style="text-align: center; text-wrap: balance; font-style: italic;">
    GitHub Actions more or less does the job, usually, eventually. Just don't ask <a href="https://nesbitt.io/2025/12/06/github-actions-package-manager.html">how it works under the hood</a>.
  </figcaption>
</figure>


In the interests of not polluting my Git log, I force-pushed my way around the errors. Eventually it worked! You can play my boring version 1 Pong [here](https://six-school.github.io/cart315/).
